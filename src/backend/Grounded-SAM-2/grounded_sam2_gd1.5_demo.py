...
Hyper parameters
"""
API_TOKEN = "4c4341b203f591d31db29164e9e937d8"
# view_000
# TEXT_PROMPT = "door . dustbin . cabinet ."
# view_001
# TEXT_PROMPT = "chair . sofa . board . cushion ."
# view_002
TEXT_PROMPT = "TV.chair.cabinet.computer.printer.water dispenser.box.luggage."
IMG_PATH = "../object_views/camera_test/view_002.png"
...
OUTPUT_DIR = Path("../object_views/result")
...
if WITH_SLICE_INFERENCE:
    ...
    objects = result.get('objects',[])  # the list of detected objects
